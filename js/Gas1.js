...
/*  while(i != (liters.length-1)){        
  ...
  div_txt_liters_consumed.append(`<label class="form-label text-uppercase fw-nomal fs-2">${/*liters_consumed*/litrosDay.toFixed(2)/*litrosDay.toFixed(2)*/ } L</label>`);  
  div_txt_liters_consumedf.append(`<label class="form-label text-uppercase fw-nomal fs-2">${monedaMX(total_constt)} </label>`);  
